...
func (c *LocalClient) ABCIQueryWithOptions(ctx context.Context, path string, data bytes.HexBytes, opts client.ABCIQueryOptions) (*ctypes.ResultABCIQuery, error) {
	if c.client == nil {
...
func (c *LocalClient) CheckTx(ctx context.Context, tx tm.Tx) (*ctypes.ResultCheckTx, error) {
	if c.client == nil {
		return nil, ErrNotInitialized
	}
...
// called.
func (c *LocalClient) BroadcastTxAsync(ctx context.Context, tx tm.Tx) (*ctypes.ResultBroadcastTx, error) {
	if c.client == nil {
...
func (c *LocalClient) BroadcastTxSync(ctx context.Context, tx tm.Tx) (*ctypes.ResultBroadcastTx, error) {
	if c.client == nil {
		return nil, ErrNotInitialized
	}
...
// BroadcastTxSync implements client.ABCIClient.BroadcastTxSync. Returns
// ErrNotInitialized if Set has not been called.
func (c *LocalClient) Tx(ctx context.Context, hash []byte, prove bool) (*ctypes.ResultTx, error) {
	if c.client == nil {
		return nil, ErrNotInitialized
	}
